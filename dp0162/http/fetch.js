...
const seachByYear = async function ({year, canonicalURL, headers}) {
        let customHeaders = {
		    "sec-ch-ua": "\" Not A;Brand\";v=\"99\", \"Chromium\";v=\"96\", \"Google Chrome\";v=\"96\"",
        ...
        //let requestURL = `https://jurisprudencia.tsj.bo/resoluciones_avanzado?term=&proceso=&id_sala=&gestion=${year}&tipo_resolucion=&id_forma_res=&id_magistrado=&departamento=&nro_resolucion=&nro_expediente=&demandante=&demandado=&page=1`;
        let responsePage = await fetchPage({canonicalURL, requestURL, requestOptions}); 		
        return responsePage;
    };
